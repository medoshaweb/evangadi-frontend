...
function PrivacyPolicy() {
  return (
    <>
      ...
      <section className="Para_con">
        <div className="inner_paraCon3 styles.center">
          <h3 className="Titles">Privacy policy</h3>
          <p className="para_text styles.center">
          ...
          <h3 className="Titles">What information do we collect?</h3>
          <p className="para_text styles.center">
          ...
          <h3 className="Titles">What do we use your information for?</h3>
          <p className="para_text center">
            Any of the information we collect from you may be used in one of the
            following ways:
          </p>
          <p className="para_text center">
            <span className="bold">Personalize your experience : </span>
          ...
          <h3 className="Titles">How is this information shared?</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">How do we protect your information?</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">Do we use cookies?</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">Third party links</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">Online Privacy Policy Only</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">Terms and Conditions</h3>
          <p className="para_text center">
          ...
          <h3 className="Titles">Your Consent</h3>
          <p className="para_text center">
